  ...
  switch (value) {
    ...
    case '1':
      if (k < balance.wallet) {
        ...
        return await citel.reply(`*1000 🪙تمت زيادة سعة بنكك بمقدار  ${citel.pushName} *`);
      } else {
        return citel.reply(`*_لازم تدفع 🪙100 عشان تزود سعة البنك ~ 1000 _*`);
      }
    case '100000':
    case '2':
      if (k < balance.wallet) {
        ...
        return await citel.reply(`*100000 🪙تمت زيادة سعة بنكك بمقدار ${citel.pushName} *`);
      } else {
        return citel.reply(`*لازم تدفع 🪙1000 عشان تزود سعة البنك ~ 100000 *`);
      }
    case '10000000':
    case '3':
      if (k < balance.wallet) {
        ...
        return await citel.reply(`*10000000 🪙تمت زيادة سعة البنك بمقدار ${citel.pushName}*`);
      } else {
        return citel.reply(`لازم تدفع 🪙10000 عشان تزود سعة البنك  ~ 1000 sp`);
      }
    default:
      return await citel.reply('*مو كذاا ❌*.');
  }
});
